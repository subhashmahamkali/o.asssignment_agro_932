...
Sorghum is the 5th most cultivated cereal with a genome size of **720 Mb**\
...
[@zhang2018sweet] [@liu2021sorgsd]


I have downloaded 10 samples of wild population *(n = 10)* and 10 samples of improved sorghum data *(n = 10)*. from the mentioned paper. I have used the following code to download the data from genome sequence archive under accession number **CRA00061**.
...
wildtype data = "/work/jyanglab/subhash/0.assignment_agro_932/1.wild_sorghum/" Improved data = "/work/jyanglab/subhash/0.assignment_agro_932/2.improved_sorghum/" Rference genome (version5) = "/work/jyanglab/subhash/0.assignment_agro_932/0..refrence/Phytozome/PhytozomeV13/"
...
all the 241 sorghum lines sequences using Illumina HiSeq X ten platform and used paired end sequencing. The average sequecning depth of all teh sorghum accesions used were \~ 5-6.7 X. They called the SNPs using GATK (Genome Analysis ToolKit) after aligned with the reference genome of BTx623 (v3.1) with BWA -mem. They identified \~32 million SNPs and 4.2 million InDels from the 241 lines of sorghum.
...
They also calculated the nucleotide diversity (pi,π) and Tajima's D using VCFtools SNPs used to calculate Tajima's D in the wild and pithy population was 37 and 30 respectively. for all these analysis the S. propinquum is used as the ancestor.
